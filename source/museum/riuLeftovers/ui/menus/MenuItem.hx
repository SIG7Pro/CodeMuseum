	...
	override function create() {
		...
		for (createdEntries in selectAbles) {
			...
			var animationData = FlxAtlasFrames.fromSparrow(Paths.image(menuPrefix + createdEntries + ".png"),
				Paths.image(menuPrefix + createdEntries + ".xml")); // Applied info to animation data.
				...
				case "Options":
					{
						...
						menuOptions.animation.addByPrefix('itemFocus',
							menulowercase +
							'Selected'); // https://github.com/FunkinCrew/Funkin/blob/a380fa16e5ad521fde48fce10073be771f9ab347/source/Girlfriend.hx#L13 Reference.
