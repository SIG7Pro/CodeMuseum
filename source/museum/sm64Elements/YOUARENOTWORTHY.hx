...
class YOUARENOTWORTHY extends FlxState {
	// var swggggdgdfgdf:FlxBitmapText;
	var swggggdgdfgdf:BetaText;

	var beie02Letters:String = "0123456789" +
		"ABCDEFGHIJKLMNOPRSTUWYZs"; // Contains some extra letters not seen in 0.2 of B3313 and some letters aren't seen there. Temporary.
